...
const cards: { icon: typeof ClockIcon; title: string; description: string }[] = [
    ...
    },
    {
        ...
        description: 'UK universities continue to offer scholarships and bursaries for May entrants.',
    },
    {
        icon: ClockIcon,
        ...
        <AppPublicLayout>
            ...
            <div className="relative">
                ...
                <Wrapper className="flex h-72 items-center justify-between bg-accent-foreground/40 backdrop-blur-xs sm:h-100">
                    <div className="flex w-full flex-col items-center gap-2 pt-28 sm:gap-6 sm:pt-40">
                        <h1 className="text-3xl font-bold text-secondary capitalize sm:text-4xl">May Intake</h1>
            ...
            <Wrapper className="text-theme-foreground">
                <div className="grid gap-4 py-12">
                    <h1 className="text-center text-3xl font-bold text-theme">Why Choose May Intake?</h1>

                    <p className="text-center">The May intake offers several advantages for international students looking to study in the UK.</p>
                ...
                <div className="grid gap-4 py-12">
                    ...
                    <p className="text-center">Understanding what you need to qualify for May 2026 intake.</p>
                ...
                <div className="grid gap-4 py-12">
                    <h1 className="text-center text-3xl font-bold text-theme">Application Timeline for May 2026 Intake</h1>
